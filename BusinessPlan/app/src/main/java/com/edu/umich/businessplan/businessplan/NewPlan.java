...
public class NewPlan extends BaseActivity {
    ...
    public void clearCurrentBP() {
        ...
        //Uncomment this to clear mySharedPreferences
        //editor.clear();


        //remove the SharedPreferences generated by the last user - after submitting their plan, this
        //information is saved in SharedPreferences with the key "Business Plan"
        editor.remove("name");
        editor.remove("city");
    ...
    //intent to open the PlansOverview activity where user can see all previous business plans
